        ...
        <div className="container max-w-2xl">
          ...
          {step === 0 && (
            ...
            >
              ...
              <p className="font-bangla text-foreground font-semibold text-lg">আপনার ছবি আপলোড করুন</p>
              <p className="text-sm text-muted-foreground font-bangla mt-2">সামনে থেকে তোলা পরিষ্কার ছবি সবচেয়ে ভালো কাজ করে</p>
