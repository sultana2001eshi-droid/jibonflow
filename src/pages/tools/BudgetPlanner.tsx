        ...
        <div className="glass-card gradient-border rounded-2xl p-6 space-y-5 animate-fade-in" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="ghost" size="sm" onClick={addCategory} className="text-accent shrink-0">
                <Plus size={16} />
              </Button>
            </div>
          </div>
            ...
            <div className="glass-card gradient-border rounded-2xl p-6 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="bg-muted/50 rounded-xl p-3 text-center">
                  ...
                  <p className={`text-lg font-heading font-bold ${result.savings >= 0 ? "text-accent" : "text-destructive"}`}>
                    ৳{result.savings.toLocaleString()}
                  </p>
                </div>
                <div className="bg-muted/50 rounded-xl p-3 text-center">
                  <p className="text-xs text-muted-foreground font-bangla">সেভিংস রেট</p>
                  <p className={`text-lg font-heading font-bold ${result.percent >= 20 ? "text-accent" : "text-destructive"}`}>
                    {result.percent}%
                  </p>
                </div>
              </div>
                ...
                {result.categoryBreakdown.map((cat) => (
                  <div key={cat.name} className="space-y-1">
                    ...
                    <div className="h-2 bg-muted rounded-full overflow-hidden">
                      <div
                        className={`h-full rounded-full transition-all duration-500 ${cat.percentage > 40 ? "bg-destructive/70" : "bg-accent/70"}`}
